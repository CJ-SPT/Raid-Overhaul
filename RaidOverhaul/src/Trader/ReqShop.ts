...
export class TraderData {
	...
	public addTraderToLocales2(tables: IDatabaseTables, fullName: string, firstName: string, nickName: string, location: string, description: string): void {
		const locales = Object.values(tables.locales.global) as Record<string, string>[]
		for (const locale of locales) {
	...
	public addReqSlips(): void {
		...
		this.assortUtils.createBarterOffer("668b3c71042c73c6f9b00704", randomBrtAssortCount, 1, "5d235b4d86f7742e017bc88a", randomReqBrtCount, this.ref.tables)
		//#endregion
	}
	...
	public addContainers(): void {
		...
		this.assortUtils.createSingleCashOffer("666361eff60f4ea5a464eb70", 1, 4, Currency.ReqSlips, 200, this.ref.tables)
		this.assortUtils.createSingleCashOffer("664a55d84a90fc2c8a6305c9", 1, 1, Currency.ReqSlips, 50, this.ref.tables)
		//#endregion
	}
	...
	public addUserPresets(): void {
		...
		this.assortUtils.getCustomPresets(randomAssortCount, randomLoyaltyLevel, this.ref.importerUtil, this.ref.ragfairPriceService, this.ref.tables)
	}
	...
	public addCustomPresets(debugLogging: boolean): void {
		...
		if (this.ref.probHelper.rollChance(20, 100)) {
			try {
				if (debugLogging) {
					this.ref.logger.log(`[${this.logString}] ${customPresetArray["6632bb0f334f6b4b261ebfea"]._name} has been added to the Req Shop`, LogTextColor.GREEN)
				}
		...
		if (this.ref.probHelper.rollChance(20, 100)) {
			try {
				if (debugLogging) {
					this.ref.logger.log(`[${this.logString}] ${customPresetArray["6632bab6994fd274f96e64fb"]._name} has been added to the Req Shop`, LogTextColor.GREEN)
				}
