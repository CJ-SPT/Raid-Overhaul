...
{
    constructor(private utils: Utils, private ref: References, private traderData: TraderData) 
    {}

    public pushExports(modConfig: any, modPath: any): void
    {
        ...
        if (modConfig.Debug.ExtraLogging)
        {
            ...
            this.ref.logger.log(`[${logString}] ${gearPresetCount} total gear presets have been added`, LogTextColor.GREEN);
        }
